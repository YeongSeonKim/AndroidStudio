    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        implicitBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                i.putExtra("DATA", "소리없는 아우성");  // key,value값으로 들어감 , 추가적인 데이터를 줄때
                startActivity(i);
            }
        });
        ...
        dialBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // 전화걸기 Activity를 호출!!
                Intent i = new Intent();
                i.setAction(Intent.ACTION_DIAL); // intent객체가 가지는 상수값 ACTION_DIAL
                                                 // 이미 내부에 내장되어있는 전화걸기
                i.setData(Uri.parse("tel:01039871010")); // Uri 형식으로 들어가야함 , Uri.parse() 문자열형태로 "tel:전화번호 명시"
                startActivity(i);
            }
        });
        ...
        browserBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Uri uri = Uri.parse("http://naver.com"); // 보안해제 해야함 => mainfest에서 permission줬음
        ...
        callBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M){ // SDK버전정보 숫자정보!!
                    ...
                    // 직접 calling 하는 activity 호출!!
                    Intent i = new Intent();
                    i.setAction(Intent.ACTION_CALL); // intent객체가 가지는 상수값 ACTION_DIAL
                    // 이미 내부에 내장되어있는 전화걸기
                    i.setData(Uri.parse("tel:01039871010")); // Uri 형식으로 들어가야함 , Uri.parse() 문자열형태로 "tel:전화번호 명시"
                    startActivity(i);
                }
